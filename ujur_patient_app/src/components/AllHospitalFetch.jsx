...
import { fetchSingleHospital, getAllHospital } from '../urls/urls';
import { test_url_images } from '../config/environment';
import { FaLocationDot } from 'react-icons/fa6';

const AllHospitalFetchComponent = () => {
   ...
   const fetchNearbyHospital = () => {
    allDoctorFetch(getAllHospital({hospitalId:hospitalId, pageNumber:showAllNumber}));
    };
...
<div style={{
  ...
  <div className="doctor-profile d-flex flex-column vh-100">
    <BackNavbar name={"View All Hospitals"} />
    {/* body */}
                ...
                <div className="position-absolute m-2">
                  ...
                  <div className="card-body small p-3 osahan-card-body">
                   ...
                   {data?.name}
                    ...
                    {data?.address && data.address.length > 21 ? data.address.substring(0, 22) + '...' : data.address}
                    </p>
...
export default AllHospitalFetchComponent