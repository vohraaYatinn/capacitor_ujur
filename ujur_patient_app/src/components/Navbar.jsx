...
const Navbar = () => {
		...
		<Drawer
			...
			<>
				<ul className="second-nav p-0" style={{ listStyle: "none" }}>
					<li
						className="osahan-user-profile bg-primary"
						style={{ padding: "1rem" }}>
								...
								<img
									src={
										user?.profile_picture
											? test_url_images + user?.profile_picture
											: user99
									}
									width={50}
									style={{
    ...
    <h5
        className="text-white-50 m-0 small"
        ...
        {user?.ujur_id}
					...
					<li
						...
						<p style={{ textDecoration: "none" }}>
							<span className="mdi mdi-account me-3"></span>My Profile
						</p>
						<hr />
					</li>
					<li
					...
					<li
						...
						<p style={{ textDecoration: "none" }}>
							<span className="mdi mdi-heart me-3"></span>Favourite
							Doctors
						</p>
						<hr />
					</li>
            ...
            >
               ...
               Search
					...
					<li
						...
						<div>+91 7682097070 support@ujurcare.com</div>
					</li>
				</ul>
			</>
		</Drawer>
