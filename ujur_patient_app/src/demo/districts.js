export const districts = {
   ...
   " Dadra and Nagar Haveli (UT)":[
    ...
    "Thrissur", "Wayanad"],
    "Lakshadweep (UT)":[
    "Agatti Island", "Amini", "Andrott", "Bithra", "Chetlat", "Kadmat", "Kalpeni", 
    ...
    "Kanpur Nagar", "Kasganj (Kanshi Ram Nagar)", "Kaushambi", "Kushinagar (Padrauna)", 
    ...
    "Sambhal (Bhim Nagar)", "Sant Kabir Nagar", "Shahjahanpur", "Shamli", "Shrawasti", 
